  ...
  <div>
    ...
    >
      ...
      >
        ...
        <nav class="nav overflow-auto py-2">
          <ul class="list-unstyled d-lg-flex align-items-center m-0">
            ...
            <li class="position-relative py-1 py-lg-0 mb-3 mb-lg-0 order-0 order-lg-6">
              <g-link
                to="/contatti"
            ...
            <li class="position-relative py-1 py-lg-0 order-2">
              <g-link
                to="/competenze"
            ...
            <li class="position-relative py-1 py-lg-0 show-link order-3">
